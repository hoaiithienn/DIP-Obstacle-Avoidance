...
%  \def\refname{T\`ai li\d\ecircumflex u}%
  \def\Acknowledgmentname{L\`\ohorn i c\h{a}m \ohorn n}%
  \def\refname{T\`ai li\d\ecircumflex u tham kh\h{a}o}%
%  \def\abstractname{T\'om t\'\abreve t n\d\ocircumflex i dung}
  \def\abstractname{T\'om t\'\abreve t}
  \def\IEEEkeywordsname{T\`\uhorn \, kh\'oa}
