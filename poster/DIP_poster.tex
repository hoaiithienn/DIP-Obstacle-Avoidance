...
%----------------------------------------------------------------------------------------
%
{\includegraphics[height=4em]{LogoBK.png}} % First university/lab logo on the left
{\bf\textsc{NHẬN DIỆN VẬT CẢN DI ĐỘNG TRONG VIDEO}} % Poster title
{\textsc{ Daniel Prelipcean \\  Jacobs University Bremen \\   Department of Physics and Earth Sciences}} % Author names and institution
{\includegraphics[height=4em]{LogoPFIEV.png}} % Second university/lab logo on the right
